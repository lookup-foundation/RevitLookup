...
| Element                   | ElementSupportsMultiAlign                    | AnnotationMultipleAlignmentUtils.ElementSupportsMultiAlign                       |
...
| ElementType               | GetRebarCrankLengthMultiplier                | -                                                                                |
| ElementType               | GetRebarCrankOffsetMultiplier                | -                                                                                |
| ElementType               | GetRebarCrankRatio                           | -                                                                                |
| ElementType               | GetRebarSpliceLapLengthMultiplier            | -                                                                                |
| ElementType               | GetRebarSpliceShiftOption                    | -                                                                                |
| ElementType               | GetRebarSpliceStaggerLengthMultiplier        | -                                                                                |
| ElementType               | GetCoordinationModelTransparencyOverride     | -                                                                                |
...
| FamilyInstance            | GetMassGrossFloorArea                        | -                                                                                |
| FamilyInstance            | GetMassGrossSurfaceArea                      | -                                                                                |
| FamilyInstance            | GetMassGrossVolume                           | -                                                                                |
| FamilyInstance            | GetMassJoinedElementIds                      | -                                                                                |
...
| FamilyInstance            | CanSetFramingEndReference                    | -                                                                                |
| FamilyInstance            | GetFramingEndReference                       | -                                                                                |
| FamilyInstance            | IsFramingJoinAllowedAtEnd                    | -                                                                                |
...
| ExternalDefinition        | GetOrCreateRebarShapeParameterElementId      | -                                                                                |
| ExternalDefinition        | GetRebarShapeParameterElementId              | -                                                                                |
| ExternalDefinition        | IsValidExternalDefinition                    | RebarShapeParameters.IsValidExternalDefinition                                   |
| ExternalResourceType      | GetServers                                   | -                                                                                |
